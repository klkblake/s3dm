...
func sameSide(p1, p2, a, b Position) bool {
	bsuba := b.Sub(a).V3()
	cp1 := bsuba.Cross(p1.Sub(a).V3())
	cp2 := bsuba.Cross(p2.Sub(a).V3())
...
func (t *staticTri) Normal() V3 {
	// Cross( p2 - p1, p3 - p1 )
	return t.p2.Sub(t.p1).V3().Cross(t.p3.Sub(t.p1).V3()).Unit()
}
...
func (t *staticTri) Center() Position {
	...
	a := t.p2.Sub(t.p1).V3()
	b := t.p3.Sub(t.p1).V3()
	return t.p1.Addf(a.Add(b).Muls(1. / 3))
}
...
func (t *Tri) Points() (Position, Position, Position) {
	...
	return t.Position.Addf(rot.Mulv(t.p1)), t.Position.Addf(rot.Mulv(t.p2)), t.Position.Addf(rot.Mulv(t.p3))
}
...
func (t *Tri) Normal() V3 {
	p1 := t.Position.Addf(t.p1.Rotate(t.Rotation))
	p2 := t.Position.Addf(t.p2.Rotate(t.Rotation))
	p3 := t.Position.Addf(t.p3.Rotate(t.Rotation))
